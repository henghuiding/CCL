function IFCN_PascalVOC(varargin)
%FNCTRAIN Train IFCN model using MatConvNet

run ~/codes/matconvnet-1.0-beta23/matlab/vl_setupnn ;
addpath ~/codes/matconvnet-1.0-beta23/examples ;
...
opts.imageSize = 512;
opts.layers = 6;%old 6
opts.kerSize = 5; % must be odd number%old 5
opts.stream = 'all';
...
% Almost fixed
opts.dataset = 'VOC';
opts.dataDir = '/home/bshuai/datasets/VOC2012/';
...
if vgg
    opts.cocoModelPath = 'PascalVOC_512_COCO/LR0.5-batch-coco-ifcn8s-5x5-6layers-1e-3-higher3/net-epoch-15.mat';
    opts.sourceModelPath = '/home/bshuai/codes/imagenet/imagenet-vgg-verydeep-16.mat' ;
    % Path Setting
    networkFolder = sprintf('mat23-CW(5_6/900bn)-nh512-batch-i%s-%dx%d-%dlayers-1e-3-higher%d', ...'
